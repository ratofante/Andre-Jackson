...
!function (D, u) {
  ...
  function s(D, u) {
    var e;
    return l(D) ? D : "string" == (e = _typeof(D)) && !u && D ? d.call(Q.querySelectorAll(D), 0) : D && "object" == e && "length" in D ? d.call(D, 0) : D ? [D] : [];
  }
...
/* harmony import */ var _libraries_SplitText__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../libraries/SplitText */ "./src/js/libraries/SplitText.js");
/* harmony import */ var _libraries_SplitText__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_libraries_SplitText__WEBPACK_IMPORTED_MODULE_0__);
...
var Init = /*#__PURE__*/function () {
  ...
  _createClass(Init, [{
    ...
    value: function loading() {
      gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.set('.mask', {
        opacity: 0,
        zIndex: -100
      });
    ...
    value: function opening() {
      var portraits = document.querySelectorAll('.portrait-face');
      var andre = new (_libraries_SplitText__WEBPACK_IMPORTED_MODULE_0___default())('#andre', {
        type: 'chars'
      }).chars;
      this.tl.to('.bar', {
        onStart: function onStart() {
          gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.set('.load-bar', {
        ...
        duration: 1,
        clipPath: 'polygon(10% 90%, 90% 90%, 90% 10%, 10% 10%)'
      }, "-=1.2").to(portraits[1].childNodes[1], {
        duration: 2,
        scale: 0.8
      }, "<").to(portraits[2], {
        duration: 1,
        clipPath: 'polygon(10% 90%, 90% 90%, 90% 10%, 10% 10%)'
      }, "-=1.2").to(portraits[2].childNodes[1], {
        duration: 2,
        scale: 0.8
      }, "<").to('.portrait', {
        duration: 1,
        ...
        duration: 2,
        clipPath: 'polygon(0vw 5vh, 100vw 5vh, 100vw 100vh, 0vw 100vh)'
      }, "<").from(andre, {
        duration: .4,
        stagger: 0.025,
        y: 30,
...
/* harmony import */ var _sections_init__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./sections/init */ "./src/js/sections/init.js");
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var imagesLoaded = __webpack_require__(/*! imagesloaded */ "./node_modules/imagesloaded/imagesloaded.js"); //FONTS


  var almendra = new FontFaceObserver('Almendra Display');
  ...
  var images = imagesLoaded(document.querySelectorAll('img'));
  images.on('done', function (instance) {
    console.log('-- images loaded');
  });
  var promises = [lato300.load(null, 12000), lato400.load(null, 12000), lato700.load(null, 12000), lato900.load(null, 12000), almendra.load(null, 12000), images];
  Promise.all(promises).then(function (values) {
    console.log('-- all Promises resolved', values);
    var init = new _sections_init__WEBPACK_IMPORTED_MODULE_1__["default"]();
    init.loading();
    init.opening();
  });
});
...
/******/ })()
;
//# sourceMappingURL=bundle.62821362a733057d290f.js.map